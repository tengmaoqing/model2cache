...
var src_AutoSaveForm =
/*#__PURE__*/
function () {
  function AutoSaveForm() {
    _classCallCheck(this, AutoSaveForm);

    this.init.apply(this, arguments);
  }

  _createClass(AutoSaveForm, [{
    key: "init",
    ...
    value: function getLocalDate(key) {
      var cachev = localStorage.getItem("".concat(this.cachePrefix).concat(key));

      if (!cachev) {
        return get_default()(this.vm, key);
      }
  ...
  install: function install(Vue, options) {
    Vue.mixin({
      mounted: function mounted() {
        ...
        this.$autoSave = new src_AutoSaveForm(this, options);
...
/* harmony default export */ var src = (AutoSaveFormForVue);
...
/******/ });
//# sourceMappingURL=vueFormCache.common.js.map